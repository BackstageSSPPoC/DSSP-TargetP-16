...
pipeline {
    ...
    environment {
        APP_NAME = "DSSP-TargetP-16".toLowerCase().trim()
        DOCKER_IMAGE = "chaitanyapandeygspann/DSSP-TargetP-16"
...
// ================= CI STAGES =================
        ...
        stage('Setup Environment') {
            steps {
                sh '''
                python3 -m venv venv && source venv/bin/activate && 3 install --upgrade pip && pip3 install -r requirements.txt
                '''
            }
        }
